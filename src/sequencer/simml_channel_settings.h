...
public:
	...
	void set_pg_type(int p_index, int p_value);

	Vector<int> get_pt_type_list() const { return _pt_type_list; }
	int get_pt_type(int p_index) const;
	void set_pt_type(int p_index, int p_value);
