...
SiMMLSimulatorSID::SiMMLSimulatorSID() :
		SiMMLSimulatorBase(SiMMLTable::MT_SID, 3, memnew(SiMMLSimulatorVoiceSet(11))) {
	...
	_default_voice_set->set_voice(8, memnew(SiMMLSimulatorVoice(SiOPMTable::PG_TRIANGLE, SiOPMTable::PT_PSG)));
	_default_voice_set->set_voice(9, memnew(SiMMLSimulatorVoice(SiOPMTable::PG_SAW_UP, SiOPMTable::PT_PSG)));
	_default_voice_set->set_voice(10, memnew(SiMMLSimulatorVoice(SiOPMTable::PG_NOISE_PULSE, SiOPMTable::PT_OPM_NOISE)));
